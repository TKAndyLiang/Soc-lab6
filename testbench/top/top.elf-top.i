# 0 "top.c"
# 1 "/home/ubuntu/caravel-soc_fpga-lab/lab-wlos_baseline/testbench/top//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "top.c"
# 19 "top.c"
...
void main()
{
 int j;
    ...
    int mask;
# 80 "top.c"
 (*(volatile uint32_t*)0x260000b8) = 0x0403;
    (*(volatile uint32_t*)0x260000b4) = 0x0403;
    (*(volatile uint32_t*)0x260000b0) = 0x0403;
    (*(volatile uint32_t*)0x260000ac) = 0x0403;
    (*(volatile uint32_t*)0x260000a8) = 0x0403;
    (*(volatile uint32_t*)0x260000a4) = 0x0403;
